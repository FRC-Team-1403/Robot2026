...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        ...
        .withKS(0.1).withKV(1.57).withKA(0)
    ...
    private static final TalonFXSConfiguration steerInitialConfigs = new TalonFXSConfiguration()
        .withCurrentLimits(
            new CurrentLimitsConfigs()
                ...
                .withStatorCurrentLimit(Amps.of(60)) // privious 60 
    ...
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(4.58); //previous 4.58
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(-0.162109375);
