...
public class Intake extends SubsystemBase{
    ...
    private final StatusSignal<AngularVelocity> m_intakeVelocity;
     ...
     public Intake() {
        ...
        intakeConfig.OpenLoopRamps.DutyCycleOpenLoopRampPeriod = 0.3;
        ...
        intakeFollowerConfg.OpenLoopRamps.DutyCycleOpenLoopRampPeriod = 0.3;
        ...
        m_intakeFollower.setControl(new Follower(Constants.Intake.m_intakeTurretSideLeaderID, MotorAlignmentValue.Opposed));
    ...
    public void periodic() {
        ...
        Logger.recordOutput("Intake/Leader Supply Current", m_intake.getSupplyCurrent().getValueAsDouble());
