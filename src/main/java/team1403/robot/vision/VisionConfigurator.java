...
public class VisionConfigurator {
    ...
    private Consumer<VisionData> m_visionConsumer = null;
    ...
    private Matrix<N3, N1> m_deviationsTrig = VecBuilder.fill(
        1,
        1,
    ...
    public VisionConfigurator withRobotPose(
        Supplier<Pose2d> pose,
        DoubleSupplier pose_timestamp
    ) {
        m_robotPose = pose;
    ...
    public VisionConfigurator withVisionConsumer(
        Consumer<VisionData> consumer
    ) {
        m_visionConsumer = consumer;
        return this;
    }
    ...
    public boolean getTrigSolveEnabled() {
        return (
            m_enableTrigSolve && m_robotPose != null && m_poseTimestamp != null
        );
    }
    ...
    public Consumer<VisionData> getVisionConsumer() {
        return m_visionConsumer;
    }
